...
Issues observed in the Soloship-vendored `browse` skill that originate in upstream gstack and don't have local fixes yet. None are shipping blockers — every one has a documented workaround.
