...
B=""
[ -n "$_ROOT" ] && [ -x "$_ROOT/.claude/skills/gstack/gs-browse/dist/gs-browse" ] && B="$_ROOT/.claude/skills/gstack/gs-browse/dist/gs-browse"
[ -z "$B" ] && B="$HOME/.claude/skills/gstack/gs-browse/dist/gs-browse"
if [ -x "$B" ]; then
  echo "READY: $B"
else
  echo "NEEDS_SETUP"
