...
Locate `gs-office-hours`'s SKILL.md (use Glob pattern `**/soloship/**/skills/gs-office-hours/SKILL.md` or `~/.claude/skills/soloship-gs-office-hours/SKILL.md`). Read it with the Read tool.
...
Load reference: find `dx-hall-of-fame.md` (sibling of this SKILL.md — use Glob pattern `**/gs-plan-devex-review/dx-hall-of-fame.md` to locate it), then read the "## Pass 1" section from it.
...
Load reference: find `dx-hall-of-fame.md` (sibling of this SKILL.md — use Glob pattern `**/gs-plan-devex-review/dx-hall-of-fame.md` to locate it), then read the "## Pass 2" section from it.
...
Load reference: find `dx-hall-of-fame.md` (sibling of this SKILL.md — use Glob pattern `**/gs-plan-devex-review/dx-hall-of-fame.md` to locate it), then read the "## Pass 3" section from it.
...
Load reference: find `dx-hall-of-fame.md` (sibling of this SKILL.md — use Glob pattern `**/gs-plan-devex-review/dx-hall-of-fame.md` to locate it), then read the "## Pass 4" section from it.
...
Load reference: find `dx-hall-of-fame.md` (sibling of this SKILL.md — use Glob pattern `**/gs-plan-devex-review/dx-hall-of-fame.md` to locate it), then read the "## Pass 5" section from it.
...
Load reference: find `dx-hall-of-fame.md` (sibling of this SKILL.md — use Glob pattern `**/gs-plan-devex-review/dx-hall-of-fame.md` to locate it), then read the "## Pass 6" section from it.
...
Load reference: find `dx-hall-of-fame.md` (sibling of this SKILL.md — use Glob pattern `**/gs-plan-devex-review/dx-hall-of-fame.md` to locate it), then read the "## Pass 7" section from it.
...
Load reference: find `dx-hall-of-fame.md` (sibling of this SKILL.md — use Glob pattern `**/gs-plan-devex-review/dx-hall-of-fame.md` to locate it), then read the "## Pass 8" section from it.
