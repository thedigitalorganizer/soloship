...
| Output dir | `.gstack/qa-reports/` | `Output to /tmp/gs-qa` |
...
1. **Project-scoped test plans:** Check `~/.gstack/projects/` for recent `*-test-plan-*.md` files for this repo
   ...
   ```
2. **Conversation context:** Check if a prior `/gs-plan-eng-review` or `/gs-plan-ceo-review` produced test plan output in this conversation
...
This is the **primary mode** for developers verifying their work. When the user says `/gs-qa` without a URL and the repo is on a feature branch, automatically:
