...
- `docs/plans/*.md` — Plan files created by `/soloship:plan`. These are living documents that track implementation progress (checkboxes are checked off by `/soloship:implement`).
