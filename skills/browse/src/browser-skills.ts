 ...
 *   project:  <project>/.soloship/browser-skills/<name>/
 *   global:   ~/.soloship/browser-skills/<name>/
 *   bundled:  <soloship-install>/browser-skills/<name>/   (read-only, ships with soloship)
 *
...
export function defaultTierPaths(opts: { projectRoot?: string; home?: string; bundledRoot?: string } = {}): TierPaths {
  ...
  return {
    project: projectRoot ? path.join(projectRoot, '.soloship', 'browser-skills') : null,
    global: path.join(home, '.soloship', 'browser-skills'),
...
function detectBundledRoot(): string {
  // The browse binary lives at <soloship-install>/browse/dist/browse.
  // The bundled browser-skills/ dir is a sibling of browse/ (i.e. <soloship-install>/browser-skills/).
  ...
  // browse/src/browser-skills.ts → ../../  (the soloship root).
