...
describe('CLI server script resolution', () => {
  test('prefers adjacent browse/src/server.ts for compiled project installs', () => {
    ...
    const execPath = path.join(root, '.claude/skills/soloship/skills/browse/dist/browse');
    const serverPath = path.join(root, '.claude/skills/soloship/skills/browse/src/server.ts');
