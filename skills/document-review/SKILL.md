...
**If no document is specified:** Ask which document to review, or look for the most recent brainstorm/plan in `docs/drafts/` or `docs/plans/`.
...
If invoked within a workflow (after `/soloship:brainstorm` or `/soloship:plan`), also check:
