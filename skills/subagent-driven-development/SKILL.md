...
digraph process {
    ...
    "Dispatch final code reviewer subagent (../../agents/code-reviewer.md)" -> "Use /soloship:finish";
}
```
...
- At skill start, check for a ledger:
  `cat "$(git rev-parse --show-toplevel)/.ai/sdd/progress.md"`. Tasks listed there
...
- Final whole-branch review: use Soloship's code-reviewer agent ([agents/code-reviewer.md](../../agents/code-reviewer.md))
...
- **the code-reviewer agent** - Code review template for the final whole-branch review
- **/soloship:finish** - Complete development after all tasks
