...
digraph process {
    ...
    "Dispatch final code reviewer (../../agents/code-reviewer.md)" [shape=box];
    "Final findings? ONE fix dispatch, one scoped re-review, adjudicate residuals" [shape=box];
    "Final review clean: delete this plan's workspace" [shape=box];
    "Use /soloship:finish" [shape=box style=filled fillcolor=lightgreen];
    ...
    "More tasks remain?" -> "Dispatch final code reviewer (../../agents/code-reviewer.md)" [label="no"];
    "Dispatch final code reviewer (../../agents/code-reviewer.md)" -> "Final findings? ONE fix dispatch, one scoped re-review, adjudicate residuals";
    "Final findings? ONE fix dispatch, one scoped re-review, adjudicate residuals" -> "Final review clean: delete this plan's workspace";
    "Final review clean: delete this plan's workspace" -> "Use /soloship:finish";
}
```
...
- Each plan owns a workspace: at skill start, run this skill's
  ...
  directory (`<repo-root>/.ai/sdd/<plan-basename>/`), home to
...
- Check for this plan's ledger at `<workspace>/progress.md`. If its first
  ...
  ledger at the old flat path `.ai/sdd/progress.md` — is another
...
Soloship's code-reviewer agent
([code-reviewer.md](../../agents/code-reviewer.md)). Point it at
...
/soloship:finish presents the options.
...
You: "User level (~/.config/your-tool/hooks/)"
