...
version: 1.1.0
description: |
  Soloship — Fast headless browser for QA testing and site dogfooding. Navigate any URL, interact with
...
`$B` is the browse binary (resolved by the SETUP block above; lives in the Soloship-bundled `skills/gs-browse/dist/browse`).
