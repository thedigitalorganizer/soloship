...
- <!-- concern:component-reuse -->
  ...
  `references/component-inventory.md`). Tasks should say "extend component X"
  over "create new component" whenever the inventory has a purpose match.
...
> **For Claude:** Required sub-skill: use subagent-driven-development (recommended) or executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
