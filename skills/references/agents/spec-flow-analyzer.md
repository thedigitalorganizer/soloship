...
1. Use the native content-search tool (e.g., Grep in Claude Code) to find code related to the feature area -- data models, route handlers, components, services/modules, API endpoints, existing tests
...
Use what was found in Phase 1 to ground this analysis. If the codebase already handles a concern (e.g., there's centralized error-handling middleware), don't flag it as a gap.
