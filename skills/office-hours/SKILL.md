...
description: |
  ...
  Use before /ceo-review or /eng-review.
allowed-tools:
  - Bash
  - Read
  - Grep
...
**"Design doc saved to: {full path}. Other skills (/ceo-review, /eng-review) will find it automatically."**
...
- **`/ceo-review`** for ambitious features (EXPANSION mode) — rethink the problem, find the 10-star product
- **`/eng-review`** for well-scoped implementation planning — lock in architecture, tests, edge cases
