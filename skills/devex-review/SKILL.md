...
# /devex-review: Developer Experience Plan Review
...
\``dx-hall-of-fame.md` (sibling of this SKILL.md)\`
...
"This plan doesn't appear to have developer-facing surfaces. /devex-review
reviews plans for APIs, CLIs, SDKs, libraries, platforms, and docs. Consider
/eng-review or /plan-design-review instead." Exit gracefully.
...
Load the "## Pass 1" section from ``dx-hall-of-fame.md` (sibling of this SKILL.md)`
...
Load reference: find `dx-hall-of-fame.md` (sibling of this SKILL.md — use Glob pattern `**/devex-review/dx-hall-of-fame.md` to locate it), then read the "## Pass 1" section from it.
...
Load reference: find `dx-hall-of-fame.md` (sibling of this SKILL.md — use Glob pattern `**/devex-review/dx-hall-of-fame.md` to locate it), then read the "## Pass 2" section from it.
...
Load reference: find `dx-hall-of-fame.md` (sibling of this SKILL.md — use Glob pattern `**/devex-review/dx-hall-of-fame.md` to locate it), then read the "## Pass 3" section from it.
...
Load reference: find `dx-hall-of-fame.md` (sibling of this SKILL.md — use Glob pattern `**/devex-review/dx-hall-of-fame.md` to locate it), then read the "## Pass 4" section from it.
...
Load reference: find `dx-hall-of-fame.md` (sibling of this SKILL.md — use Glob pattern `**/devex-review/dx-hall-of-fame.md` to locate it), then read the "## Pass 5" section from it.
...
Load reference: find `dx-hall-of-fame.md` (sibling of this SKILL.md — use Glob pattern `**/devex-review/dx-hall-of-fame.md` to locate it), then read the "## Pass 6" section from it.
...
Load reference: find `dx-hall-of-fame.md` (sibling of this SKILL.md — use Glob pattern `**/devex-review/dx-hall-of-fame.md` to locate it), then read the "## Pass 7" section from it.
...
Load reference: find `dx-hall-of-fame.md` (sibling of this SKILL.md — use Glob pattern `**/devex-review/dx-hall-of-fame.md` to locate it), then read the "## Pass 8" section from it.
...
`~/.soloship/` (user config directory, not project files).
...
**Recommend /eng-review if eng review is not skipped globally** — DX issues often
