...
If the Skill tool cannot find `im-clarify` by that exact name, read `${CLAUDE_PLUGIN_ROOT}/skills/im-clarify/SKILL.md` directly (or fall back to `~/.claude/plugins/marketplaces/soloship/skills/im-clarify/SKILL.md`) and execute its instructions as a complete workflow.
