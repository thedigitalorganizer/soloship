...
If the Skill tool cannot find `ce-document-review` by that exact name, read `${CLAUDE_PLUGIN_ROOT}/skills/ce-document-review/SKILL.md` directly (or fall back to `~/.claude/plugins/marketplaces/soloship/skills/ce-document-review/SKILL.md`) and execute its instructions as a complete workflow.
