...
If the Skill tool cannot find `im-simplify` by that exact name, read `${CLAUDE_PLUGIN_ROOT}/skills/im-simplify/SKILL.md` directly (or fall back to `~/.claude/plugins/marketplaces/soloship/skills/im-simplify/SKILL.md`) and execute its instructions as a complete workflow.
