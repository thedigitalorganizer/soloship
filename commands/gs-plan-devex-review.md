...
If the Skill tool cannot find `gs-plan-devex-review` by that exact name, read `${CLAUDE_PLUGIN_ROOT}/skills/gs-plan-devex-review/SKILL.md` directly (or fall back to `~/.claude/plugins/marketplaces/soloship/skills/gs-plan-devex-review/SKILL.md`) and execute its instructions as a complete workflow.
