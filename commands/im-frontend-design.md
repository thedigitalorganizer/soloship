...
If the Skill tool cannot find `im-frontend-design` by that exact name, read `${CLAUDE_PLUGIN_ROOT}/skills/im-frontend-design/SKILL.md` directly (or fall back to `~/.claude/plugins/marketplaces/soloship/skills/im-frontend-design/SKILL.md`) and execute its instructions as a complete workflow.
