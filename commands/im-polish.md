...
If the Skill tool cannot find `im-polish` by that exact name, read `${CLAUDE_PLUGIN_ROOT}/skills/im-polish/SKILL.md` directly (or fall back to `~/.claude/plugins/marketplaces/soloship/skills/im-polish/SKILL.md`) and execute its instructions as a complete workflow.
