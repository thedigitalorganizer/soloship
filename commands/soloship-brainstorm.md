...
If the Skill tool cannot find `brainstorm` by that exact name, read `${CLAUDE_PLUGIN_ROOT}/skills/brainstorm/SKILL.md` directly (or fall back to `~/.claude/plugins/marketplaces/soloship/skills/brainstorm/SKILL.md`) and execute its instructions as a complete workflow.
