---
name: learn
description: Capture knowledge from non-obvious work. Creates a solution doc via ce-compound, then audits the architecture registry for drift, propagates new pitfalls into AGENTS.md files, and creates missing AGENTS.md for directories that have grown past the governance threshold. Cherry-picks the learnings.jsonl persistence pattern for quick cross-session search.
---
