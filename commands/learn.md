---
name: learn
description: Capture knowledge from non-obvious work. Creates a solution doc via the Compound-Engineering-derived compound methodology, then audits the architecture registry for drift, propagates new pitfalls into AGENTS.md files, and creates missing AGENTS.md for directories past the governance threshold. Adds learnings.jsonl persistence for cross-session search.
---
